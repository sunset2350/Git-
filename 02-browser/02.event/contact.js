...
// 우선순위에 따라서 1을 좀 더 시간을 많이 할애, 2는 약감나 할애
(async () => {
  // fetch(..)
  // http 접속을 통해서 데이털르 가져오거나 보내거나 할 수 있음
  // await Promise 객체
  ...
  // 배열 반복을 해서 tr을 만든 후 tbody 가장 마지막 자식에 추가
...
//   console.log(3);
//   // 네트워크 요청처리는 처리시간이 길다.
//   // UI 처리와 네트워크처리를 같은 컨텍스트에서 하면
//   // 네트워크 요청처리가 끝날때까지 브라우즈는 멈춤
// })();
